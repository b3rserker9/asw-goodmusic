...
@Component
public class ConnessioneDeletedEventPublisher implements ConnessioniEventPublisher {
    ...
    private String channel = ConnessioneEventChannel.deletedChannel;

    @Override
    public void publish(DomainEvent event) {
        logger.info("CONNESSIONI DELETED EVENT PUBLISHER: " + event.toString() + " ON CHANNEL: " + channel);
